...
class Data:
    ...
    def create_openai_properties(cls):
        ...
        Data.update_descriptions_from_docstring(doc_info, fields)
        
        fields["required"] = Data.find_required_fields(fields)
    ...
    def transform(data, target_schema, model="gpt-3.5-turbo"):
        ...
        schema = Data.create_openai_properties(target_schema)
