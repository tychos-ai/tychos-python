...
class Functions:
    ...
    def create_openai_properties(cls):
        ...
        Functions.update_descriptions_from_docstring(doc_info, fields)
        
        fields["required"] = Functions.find_required_fields(fields)
        
        return fields

    def ai_transform(data, target_schema, model="gpt-3.5-turbo"):
        ...
        schema = Functions.create_openai_properties(target_schema)
